...
<div class="container-fluid py-4">
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-auto d-flex gap-2">
            ...
            <a class="btn btn-outline-primary btn-sm" id="btn-share" href="{{ route('wrapped.share', ['slug' => $shareSlug, 'year' => $selectedYear]) }}" target="_blank" rel="noopener" data-share-url="{{ route('wrapped.share', ['slug' => $shareSlug, 'year' => $selectedYear]) }}">
